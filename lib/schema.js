...
export const leads = sqliteTable("Lead", {
  ...
  researchBrief:   text("researchBrief"),  // JSON: { confidence, companyContext, hooks, openQuestion, warnings }
...
export const appSettings = sqliteTable("AppSettings", {
  ...
  rules:          text("rules"),          // JSON array of rule strings
  emailStrategy:  text("emailStrategy"),  // Free text: high-level email strategy injected into every draft
  researchFocus:  text("researchFocus"),  // Free text: what to prioritize during research
